...
public class ContactViewController {
    ...
    void doMail(MouseEvent event) {
    	try {
			Desktop.getDesktop().mail(new URI("mailto:simranpreet1003@gmail.com?subject=Blood_Bank_Assistant"));;
    ...
    void showGithub(MouseEvent event) {
    	try {
			Desktop.getDesktop().browse(new URI("https://github.com/Simranpreet-Singh-TIET"));
